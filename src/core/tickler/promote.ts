...
// задача должна прийти именно в единый настроенный inbox, а не просто остаться
// на месте (это поведение promoteTo="origin").
// ---------------------------------------------------------------------------
...
export interface PlannedPromotion {
	...
	stripTags: string[];
	/** Переносить ли строку в единый inbox-файл, чтобы формула
